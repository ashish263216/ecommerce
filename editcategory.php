    ...
    <?php  include_once 'navbar.php' ?>
        ...
        <div class="row mt-5">
            <div class="col-sm-6 mx-auto">
                ...
                <input type="text" class="form-control" value="<?php echo $row['cat_name'];  ?>" name="name" />
                </div>
         ...
         <div class="row mt-3">
             <div class="col-sm-12 text-center">
                ...
                <input type="submit" name="submit" value="save" class="btn btn-primary" style="width:100px;" >
             </div>
         </div>      
...
{
  $x=$_POST['name'];
  $sql1="update categories set cat_name='".$x."' where id='".$_GET['id']."'";
...
$target_file = $target_dir .basename($_FILES["fileToUpload"]['name']);
  ...
  if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
    $sql="update categories set image= '".$target_file."' where id='".$_GET['id']."'";
